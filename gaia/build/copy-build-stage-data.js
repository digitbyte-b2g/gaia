...
function moveExternalApp(webapp, source, destination) {
  ...
  if (webapp.pckManifest) {
    ...
    utils.copyFileTo(updateManifest, destination, 'update.webmanifest');
  } else {
    var manifestFile = utils.getFile(webapp.manifestFilePath);
    utils.copyFileTo(manifestFile, destination, 'manifest.webmanifest');
...
function execute(options) {
  ...
  utils.copyFileTo(stageManifest, targetManifest.path, 'manifest.webmanifest');
}
