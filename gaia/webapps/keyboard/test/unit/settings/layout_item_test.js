...
suite('LayoutItem', function() {
  ...
  setup(function() {
    ...
    realMozInputMethod = navigator.b2g.inputMethod;
    navigator.b2g.inputMethod = new MockInputMethod();
    this.sinon.stub(navigator.b2g.inputMethod, 'addInput')
      .returns(addInputDeferred.promise);
    this.sinon.stub(navigator.b2g.inputMethod, 'removeInput')
  ...
  suite('Install', function() {
    ...
    test('Sucessful installation', function(done) {
      Promise.resolve().then(function() {
        ...
        assert.isTrue(navigator.b2g.inputMethod.addInput.calledWith('fr', {
    ...
    test('Dictionary install fail', function(done) {
      Promise.resolve().then(function() {
        ...
        assert.isFalse(navigator.b2g.inputMethod.addInput.calledOnce);
  ...
  suite('remove', function() {
    ...
    test('Sucessful removal', function(done) {
      Promise.resolve().then(function() {
        ...
        assert.isTrue(navigator.b2g.inputMethod.removeInput.calledWith('fr'));
