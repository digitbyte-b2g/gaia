...
suite('index.js', function() {
  ...
  suite('initialization', function() {
    ...
    setup(function() {
      ...
      realMozAudioChannelManager = navigator.b2g.audioChannelManager;
      navigator.b2g.audioChannelManager = { volumeControlChannel: null };

      onLoadDialer();
    });

    teardown(function() {
      navigator.b2g.audioChannelManager = realMozAudioChannelManager;
    });
