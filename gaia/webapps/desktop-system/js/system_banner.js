 ...
 /**
  ...
  SystemBanner.prototype = {
    ...
    getBanner: function() {
      ...
      return LazyLoader.load('http://shared.localhost:8081/elements/gaia-component/gaia-component.js')
        .then(() => {
          return LazyLoader.load('http://shared.localhost:8081/elements/gaia-toast/gaia-toast.js');
        })
        .then(() => {
