...
suite('system/bluetooth_v2', function() {
  ...
  suiteSetup(function(done) {
    ...
    realSettings = SettingsObserver;
    SettingsObserver = MockNavigatorSettings;

    realSettingsListener = window.SettingsListener;
    window.SettingsListener = MockSettingsListener;

    realMozBluetooth = navigator.b2g.bluetooth;
  ...
  suite('Initialize', function() {
    setup(function() {
      this.sinon.spy(navigator.b2g.bluetooth, 'addEventListener');
    ...
    test('listener called', function() {
      assert.ok(navigator.b2g.bluetooth.addEventListener.
  ...
  suite('initDefaultAdapter', function() {
    ...
    test('defaultAdapter is available', function() {
      ...
      assert.equal(Bluetooth._adapter, navigator.b2g.bluetooth.defaultAdapter);
  ...
  suite('btManagerHandler', function() {
    setup(function() {
      ...
      Bluetooth._bluetooth = window.navigator.b2g.bluetooth;
    });
