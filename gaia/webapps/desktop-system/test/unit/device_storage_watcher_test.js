...
suite('system/DeviceStorageWatcher >', function() {
  ...
  suiteSetup(function(done) {
    ...
    realNavigatorGetDeviceStorage = navigator.b2g.getDeviceStorage;
    navigator.b2g.getDeviceStorage = MockNavigatorGetDeviceStorage;
  ...
  suiteTeardown(function() {
    ...
    navigator.b2g.getDeviceStorage = realNavigatorGetDeviceStorage;
  });
