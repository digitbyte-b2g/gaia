...
suite('system/UpdateManager', function() {
  ...
  suiteSetup(function() {
    realNavigatorSettings = SettingsObserver;
  ...
  suiteTeardown(function() {
    SettingsObserver = realNavigatorSettings;
  ...
  suite('System updates', function() {
    ...
    setup(function() {
      ...
      mockMozMobileConnections = navigator.b2g.mobileConnections;
    ...
    teardown(function() {
      ...
      navigator.b2g.mobileConnections = mockMozMobileConnections;
      navigator.mozWifiManager.connection.status = 'connected';
    });
