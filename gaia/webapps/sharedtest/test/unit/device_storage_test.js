...
suite('DeviceStorage', function() {
  ...
  if (!navigator.b2g.getDeviceStorage) {
    test('navigator.b2g.getDeviceStorage() doesn\'t exist; not running tests',
         function() {});
    return;
  }

  var storageAreas = navigator.b2g.getDeviceStorage('pictures');

  if (storageAreas == null) {
    test('navigator.b2g.getDeviceStorage() returns null on this platform; ' +
         'not running tests',
         function() {});
    return;
  }
