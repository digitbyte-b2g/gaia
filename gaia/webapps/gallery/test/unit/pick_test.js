...
suite('pick', function() {
  ...
  suiteSetup(function() {
    ...
    navigator.b2g.getDeviceStorage = sinon.spy(MockGetDeviceStorage);
  ...
  suite('select', function() {
    ...
    test('Should use external preview file if specified', function() {
      navigator.b2g.getDeviceStorage.reset();
      ...
      Pick.start(activity);
      Pick.select(fileinfo);
      assert.ok(navigator.b2g.getDeviceStorage.calledWith('pictures'));
    });
  });
