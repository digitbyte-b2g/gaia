...
suite('system/LockScreen >', function() {
  ...
  setup(function() {
    ...
    SettingsObserver = window.MockNavigatorSettings;
  ...
  test('L10n initialization: it should NOT init the conn info manager if ' +
    ...
    var originalMozMobileConnections = window.navigator.b2g.mobileConnections;
    window.navigator.b2g.mobileConnections = {};
    subject._lockscreenConnInfoManager = {};
    assert.isTrue(!!(window.navigator.b2g.mobileConnections),
    ...
    assert.isFalse(stubConnInfoManager.called,
      ...
      'undefined');
    window.navigator.b2g.mobileConnections = originalMozMobileConnections;
