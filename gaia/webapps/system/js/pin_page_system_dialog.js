...
(function(exports) {
  ...
  var PinPageSystemDialog = function(controller) {
    ...
    this.options = {};
    LazyLoader.load('http://shared.localhost:8081/elements/gaia-component/gaia-component.js')
      .then(() => {
        var webComponents = [
          'http://shared.localhost:8081/elements/gaia-site-icon/script.js',
          'http://shared.localhost:8081/elements/gaia-button/gaia-button.js',
          'http://shared.localhost:8081/elements/gaia-dialog/gaia-dialog.js',
          'http://shared.localhost:8081/elements/gaia-toast/gaia-toast.js'
        ];
