...
DynamicInputRegistry.prototype.start = function() {
  ...
  navigator.b2g.inputMethod.mgmt.addEventListener('addinputrequest', this);
  navigator.b2g.inputMethod.mgmt.addEventListener('removeinputrequest', this);
};

DynamicInputRegistry.prototype.stop = function() {
  this.taskQueue = null;

  navigator.b2g.inputMethod.mgmt.removeEventListener('addinputrequest', this);
  navigator.b2g.inputMethod.mgmt.removeEventListener('removeinputrequest', this);
};
