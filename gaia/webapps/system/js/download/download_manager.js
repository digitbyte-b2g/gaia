...
var DownloadManager = (function() {
  ...
  function onDownloadStart(ev) {
    if (started) {
      ...
      LazyLoader.load(['http://shared.localhost:8081/js/download/download_formatter.js',
                       'http://shared.localhost:8081/js/download/download_ui.js',
                       'http://shared.localhost:8081/js/download/download_store.js',
                       'http://shared.localhost:8081/js/download/download_helper.js',
