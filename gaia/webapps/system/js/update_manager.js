...
(function(exports) {
  var UpdateManager = {
    ...
    start: function() {
      ...
      this._settings = SettingsObserver;
    ...
    getWifiPrioritized: function um_getWifiPrioritized() {
      ...
      var self = this;
      var getRequest = settings.getValue(this.WIFI_PRIORITIZED_KEY);
    ...
    getUpdate2GEnabled: function um_getUpdate2GEnabled() {
      ...
      var settings = window.SettingsObserver;
      var self = this;
      var getRequest = settings.getValue(this.UPDATE_2G_SETT);
    ...
    _openDownloadViaDataDialog: function um_downloadViaDataDialog() {
      ...
      var connections = window.navigator.b2g.mobileConnections;
      var dataType;
      var sim;
