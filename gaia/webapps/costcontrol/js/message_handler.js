...
(function() {
  ...
  function addAlarmTimeout(type, delay) {
    ...
    var request = navigator.b2g.alarmManager.add(date, 'ignoreTimezone', {type: type});
    return request;
  }
  ...
  function setNextReset(when, callback) {
    ...
    asyncStorage.getItem('nextResetAlarm', function(id) {
      ...
      var alarms = navigator.b2g.alarmManager;
          ...
          ConfigManager.requestAll(function _onInfo(configuration, settings) {
            ...
            if (isBalance) {
              ...
              if (settings.waitingForBalance !== null) {
                // Remove the timeout
                navigator.b2g.alarmManager.remove(settings.waitingForBalance);
              ...
              if (settings.waitingForTopUp !== null) {
                ...
                navigator.b2g.alarmManager.remove(settings.waitingForTopUp);
