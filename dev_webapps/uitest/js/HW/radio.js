...
function radioTest() {
  ...
  if (('mozIccManager' in navigator) &&
      ...
      navigator.b2g.mobileConnections.length > 0) {
    ...
    alert('navigator.mozIccManager or navigator.b2g.mobileConnections ' +
          'not supported');
  }
  ...
  function showInfo(iccId) {
    ...
    mobileConnectionInfo(navigator.b2g.mobileConnections[i],
                                                     connectionContainer);
  }
