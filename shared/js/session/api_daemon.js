!(function (exports) {
  ...
  function TimedPromise(promise, msg) {
    return new Promise((resolve, reject) => {
      ...
      promise.then(
        ...
        (error) => {
          console.error(
            `ApiDaemon TimedPromise ${msg} failure in ${Date.now() - start
            }ms : ${error}`
          );
          reject(error);
        }
  ...
  class ApiDaemon {
    constructor() {
      ...
      this.registerService('audiovolumemanager', 'AudioVolumeManager');
      this.registerService('contacts', 'ContactsManager');
      this.registerService('devicecapability', 'DeviceCapabilityManager');
      this.registerService('contentmanager', 'ContentManager');
      this.registerService('telephony', 'TelephonyManager');
    ...
    getAudioVolumeManager() {
      return this._getService('AudioVolumeManager');
    }
    ...
    getDeviceCapability() {
      return this._getService('DeviceCapabilityManager');
    }
    ...
    getTelephonyManager() {
      return this._getService('TelephonyManager');
    }
  ...
  exports.apiDaemon = new ApiDaemon();
