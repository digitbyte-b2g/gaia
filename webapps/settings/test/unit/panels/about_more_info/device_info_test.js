...
suite('about device info >', function() {
  ...
  suite('loadIccId >', function() {
    ...
    setup(function() {
      navigator.b2g.mobileConnections[0].iccId = iccIds[0];
    });
    ...
    suite('single sim', function() {
      ...
      test('should show "Not available" when iccid is unavalilable',
        function() {
          navigator.b2g.mobileConnections[0].iccId = null;
          deviceInfo._loadIccId();
    ...
    suite('multiple sim', function() {
      setup(function() {
        navigator.b2g.mobileConnections.mAddMobileConnection();
      });

      test('should show correct sim indicator', function() {
        iccIds = ['12345', '22345'];
        navigator.b2g.mobileConnections[0].iccId = iccIds[0];
        navigator.b2g.mobileConnections[1].iccId = iccIds[1];
      ...
      test('should show unavailable sim indicator', function() {
        navigator.b2g.mobileConnections[0].iccId = null;
        navigator.b2g.mobileConnections[1].iccId = null;
        this.sinon.stub(document.l10n, 'setAttributes');
        deviceInfo._loadIccId();
        var spans = deviceInfo._elements.deviceInfoIccIds
          .querySelectorAll('span');
