...
suite('STK (icc_events) >', function() {
  ...
  suiteSetup(function() {
    ...
    navigator.b2g.mobileConnections.mAddMobileConnection(conn1, 0);
    ...
    navigator.b2g.mobileConnections.mAddMobileConnection(conn2, 1);
  ...
  test('STK_EVENT_TYPE_LOCATION_STATUS - STK_SERVICE_STATE_NORMAL',
    ...
    navigator.b2g.mobileConnections[message.iccId].
  ...
  test('STK_EVENT_TYPE_LANGUAGE_SELECTION', function(done) {
    ...
    SettingsObserver.mTriggerObservers('language.current', {
      settingValue: 'en'
    });
    assert.isTrue(icc1.sendStkEventDownload.calledOnce);
    icc1.sendStkEventDownload.restore();
