...
exports.UtilityTray = {
  ...
  init: function ut_init() {
    ...
    var screenBrightness = SettingsObserver.getValue('screen.brightness');
    screenBrightness.onsuccess = function() {
      brightnessSlider.value = screenBrightness.result['screen.brightness'];
    };

    var screenAutomaticBrightness = SettingsObserver.getValue('screen.automatic-brightness');
    ...
    brightnessSlider.onchange = function() {
      SettingsObserver.setValue({ 'screen.brightness': brightnessSlider.value });
    };

    brightnessAutoCheckbox.onchange = function() {
      SettingsObserver.setValue({ 'screen.automatic-brightness': brightnessAutoCheckbox.checked });
    };
    ...
    var audioVolume = SettingsObserver.getValue('audio.volume.content');
    audioVolume.onsuccess = function() {
      audioSlider.value = audioVolume.result['audio.volume.content'];
    };

    audioSlider.onchange = function() {
      SettingsObserver.setValue({ 'audio.volume.content': audioSlider.value });
