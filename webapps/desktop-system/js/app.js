...
(function(exports) {
  ...
  App.prototype = {
    ...
    FILES: [
      ...
      'http://shared.localhost:8081/js/event_safety.js',
      'http://shared.localhost:8081/js/mobile_operator.js',
      'http://shared.localhost:8081/js/screen_layout.js',
      'http://shared.localhost:8081/js/settings_listener.js',
      'http://shared.localhost:8081/js/async_storage.js',
      'http://shared.localhost:8081/js/manifest_helper.js',
      'http://shared.localhost:8081/js/notification_helper.js',
      'http://shared.localhost:8081/js/sanitizer.js',
      'http://shared.localhost:8081/js/idletimer.js' // XXX: Move into ScreenManager
    ],
    start: function() {
