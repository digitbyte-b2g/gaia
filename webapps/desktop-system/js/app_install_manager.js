...
(function(exports) {
  var AppInstallManager = {
    ...
    start: function() {
      var lazyLoadScripts = [
        'js/system_banner.js',
        'http://shared.localhost:8081/js/addons/match_pattern.js'
      ];
      ...
      LazyLoader.load(['http://shared.localhost:8081/js/homescreens/confirm_dialog_helper.js']);
