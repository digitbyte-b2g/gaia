...
(function(exports) {
  ...
  TimeIcon.prototype.update = function(now) {
    ...
    var timeText = now.toLocaleTimeString(navigator.language, {
      hour12: navigator.mozHour12,
      hour: 'numeric',
      minute: 'numeric'
    });
    var dateText = now.toLocaleDateString(navigator.language, {
      year: 'numeric',
      month: '2-digit',
      day: '2-digit',
    });
    ...
    // }
    this.element.innerHTML = timeText + '<br>' + dateText;
