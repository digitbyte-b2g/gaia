...
MediaPlaybackWidget.prototype = {
  ...
  updateNowPlaying: function mpw_updateNowPlaying(metadata) {
    ...
    if (picture) {
      this.container.style.background = `${picture} no-repeat left top / 10rem, linear-gradient(to right, ${colorPicker(picture)[0]}, ${colorPicker(picture)[1]} no-repeat left 10rem top / calc(100% - 10rem) 10rem`;
    }
  },
