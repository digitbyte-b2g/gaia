...
header.addEventListener('action', (evt) => {
  ...
  if (viewStack.views.length > 1) {
    ...
    document.body.style.setProperty('--header-background', null);
    document.body.style.setProperty('--header-color', null);
    document.body.style.setProperty('--header-button-color', null);
