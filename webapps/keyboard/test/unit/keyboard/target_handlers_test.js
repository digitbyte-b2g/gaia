...
suite('target handlers', function() {
  ...
  suite('SpaceKeyTargetHandler', function() {
    ...
    test('longPress', function() {
      ...
      assert.isTrue(navigator.b2g.inputMethod.mgmt.hide.calledOnce);
  ...
  suite('SwitchKeyboardTargetHandler', function() {
    ...
    test('longPress', function() {
      ...
      assert.isTrue(navigator.b2g.inputMethod.mgmt.showAll.calledOnce);
    ...
    test('commit', function() {
      ...
      assert.isTrue(navigator.b2g.inputMethod.mgmt.next.calledOnce);
