...
suite('StateManager', function() {
  ...
  teardown(function() {
    ...
    navigator.b2g.inputMethod = realMozInputMethod;
  });

  suite('start with not hidden', function() {
    setup(function() {
      document.hidden = false;
      navigator.b2g.inputMethod.setInputContext(new MockInputContext());
      app.inputContext = navigator.b2g.inputMethod.inputcontext;
    ...
    suite('deactivate', function() {
      setup(function() {
        ...
        navigator.b2g.inputMethod.setInputContext();
