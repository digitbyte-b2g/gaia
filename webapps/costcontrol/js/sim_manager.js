...
var SimManager = (function() {
  ...
  function _requestServiceSIMIcc(serviceId, onsuccess, onerror) {
    ...
    var mobileConnection = navigator.b2g.mobileConnections[slotId];
  ...
  function _requestServiceConnection(serviceId) {
    var slotId = serviceIcc[serviceId].slotId;
    return navigator.b2g.mobileConnections[slotId];
  }
  ...
  return {
    isMultiSim: function() {
      ...
      return (navigator.b2g.mobileConnections.length > 1);
    },
    // data info
