...
suite('InputWindowManager', function() {
  ...
  setup(function() {
    ...
    realInputMethod = window.navigator.b2g.inputMethod;
  ...
  teardown(function() {
    navigator.b2g.inputMethod = realInputMethod;
  });
    ...
    suite('External events for hideInputWindowImmediately', function() {
      ...
      var testForHideImmeidately = function(evtType) {
        test(evtType, function() {
          ...
          assert.isTrue(navigator.b2g.inputMethod.removeFocus.called);
        });
      };
    ...
    suite('External events for removing input focus', function() {
      ...
      var testForRemoveFocus = function(evtType) {
        ...
        function() {
          ...
          assert.isFalse(navigator.b2g.inputMethod.removeFocus.called);
          assert.isFalse(
