...
suite('STK (icc) >', function() {
  ...
  suiteSetup(function() {
    ...
    realNavigatormozMobileConnections = navigator.b2g.mobileConnections;
  ...
  suiteTeardown(function() {
    ...
    navigator.b2g.mobileConnections = realNavigatormozMobileConnections;
  ...
  test('clearMenuCache', function(done) {
    window.icc.clearMenuCache(function() {
      var resetApplications = window.SettingsObserver.createLock().get(
        'icc.applications');
