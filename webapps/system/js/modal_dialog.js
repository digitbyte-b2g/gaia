...
var ModalDialog = {
  ...
  // Sounds
  alertDialogSound: new Audio('/resources/sounds/exclamation.wav'),
  confirmDialogSound: new Audio('/resources/sounds/exclamation.wav'),
  promptDialogSound: new Audio('/resources/sounds/exclamation.wav'),
  selectOneDialogSound: new Audio('/resources/sounds/exclamation.wav'),
  ...
  show: function md_show(target, origin) {
    ...
    switch (type) {
      case 'alert':
        this.alertDialogSound.currentTime = 0;
        this.alertDialogSound.play();
      ...
      case 'prompt':
        this.promptDialogSound.currentTime = 0;
        this.promptDialogSound.play();
      ...
      case 'confirm':
        this.confirmDialogSound.currentTime = 0;
        this.confirmDialogSound.play();
      ...
      case 'selectone':
        this.selectOneDialogSound.currentTime = 0;
        this.selectOneDialogSound.play();
