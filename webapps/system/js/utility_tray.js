...
exports.UtilityTray = {
  ...
  recalculateNotificationsContainerHeight() {
    this.notificationsContainer.style.maxHeight = (window.innerHeight - 95) + 'px';
  ...
  init: function ut_init() {
    ...
    screenAutomaticBrightness.onsuccess = function() {
      brightnessAutoCheckbox.value = screenAutomaticBrightness.result['screen.automatic-brightness'];
    };
  ...
  handleEvent: function ut_handleEvent(evt) {
    ...
    switch (evt.type) {
      ...
      case 'wheel':
        ...
        var notifications = document.getElementById('utility-tray-notifications');
        var quickSettings = document.getElementById('tray-footer-container');
