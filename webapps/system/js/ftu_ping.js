...
(function(exports) {
  ...
  FtuPing.prototype = {
      ...
      function getSettings() {
        return new Promise(function(resolve, reject) {
          ...
          self.getSettings(allSettings, function(settings) {
            ...
            var mozSettings = window.SettingsObserver;
    ...
    initPreinstalledApps: function fp_initPreinstalledApps(callback) {
      ...
      return new Promise(function(resolve, reject) {
        window.AppsManager.getAll().onsuccess = function(evt) {
    ...
    getSettings: function fp_getSettings(settingKeys, callback) {
      ...
      var settings = {};
      var lock = window.SettingsObserver.createLock();
    ...
    ensurePing: function fp_ensurePing() {
      var self = this;
      LazyLoader.load('http://shared.localhost:8081/js/telemetry.js').then(function() {
