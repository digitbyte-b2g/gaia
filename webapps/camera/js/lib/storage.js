...
Storage.prototype.configure = function(storageVolumeName) {
  ...
  if (!storageVolumeName) {
    this.video = navigator.b2g.getDeviceStorage('videos');
    this.picture = navigator.b2g.getDeviceStorage('pictures');
  } else { // We select the volumes with the passed name
    videosStorages = navigator.b2g.getDeviceStorages('videos');
    ...
    picturesStorages = navigator.b2g.getDeviceStorages('pictures');
